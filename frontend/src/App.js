...
const TWITTER_HANDLE = 'ajitsinghkaler';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const TOTAL_MINT_COUNT = 50;
const CONTRACT_ADDRESS = "0x0EBe4e0FB5bA6EA6358199Ba545470e92b58595c";
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">
            Total nft to be minted {TOTAL_MINT_COUNT}
          </p>
          <div className="sub-text">
            Already minted {noOfMinted}/{TOTAL_MINT_COUNT}
          </div>
          {currentAccount === "" ? (
